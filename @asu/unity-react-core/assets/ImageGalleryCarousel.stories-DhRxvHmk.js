...
@returns { JSX.Element }`,methods:[],displayName:"ImageGalleryCarousel",props:{hasContent:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},imageAutoSize:{defaultValue:{value:"true",computed:!1},description:"",type:{name:"bool"},required:!1},imageItems:{description:"",type:{name:"arrayOf",value:{name:"shape",value:{id:{name:"number",required:!1},imageSource:{name:"string",required:!1},thumbnailSource:{name:"string",required:!1},imageAltText:{name:"string",required:!1},content:{name:"union",value:[{name:"string"},{name:"element"}],required:!1}}}},required:!1},width:{description:"",type:{name:"string"},required:!1},maxWidth:{description:"",type:{name:"string"},required:!1}}};const X=()=>I.map((a,t)=>{const s=t===2?`
  ...
  `;return I.map((s,r)=>({...s,title:`Content ${r+1}`,content:r%2===1?a:t}))},se={title:"Components/Image Gallery Carousel",component:m,parameters:{controls:{disable:!0}}},b="996px",J="600px",v=({children:a=null})=>e.jsx("div",{className:"container",style:{display:"flex",maxHeight:J},children:a}),c=()=>e.jsx(v,{children:e.jsx(m,{maxWidth:b,imageItems:I})}),d=()=>e.jsx(v,{children:e.jsx(m,{maxWidth:b,imageItems:X(),hasContent:!0})}),p=()=>e.jsx(v,{children:e.jsx(m,{maxWidth:b,imageItems:F(),hasContent:!0})});c.__docgenInfo={description:"",methods:[],displayName:"ImageGalleryCarouselDefault"};d.__docgenInfo={description:"",methods:[],displayName:"ImageGalleryCarouselWithContent"};p.__docgenInfo={description:"",methods:[],displayName:"ImageCarouselWithMoreContent"};var q,k,S;c.parameters={...c.parameters,docs:{...(q=c.parameters)==null?void 0:q.docs,source:{originalSource:`() => <Wrapper>
    <ImageGalleryCarousel maxWidth={maxWidth} imageItems={imageGalleryCarouselItems} />
  </Wrapper>`,...(S=(k=c.parameters)==null?void 0:k.docs)==null?void 0:S.source}}};var w,G,A;d.parameters={...d.parameters,docs:{...(w=d.parameters)==null?void 0:w.docs,source:{originalSource:`() => <Wrapper>
    <ImageGalleryCarousel maxWidth={maxWidth} imageItems={mockItemWithContent()} hasContent />
  </Wrapper>`,...(A=(G=d.parameters)==null?void 0:G.docs)==null?void 0:A.source}}};var _,T,B;p.parameters={...p.parameters,docs:{...(_=p.parameters)==null?void 0:_.docs,source:{originalSource:`() => <Wrapper>
    <ImageGalleryCarousel maxWidth={maxWidth} imageItems={mockItemWithMoreContent()} hasContent />
  </Wrapper>`,...(B=(T=p.parameters)==null?void 0:T.docs)==null?void 0:B.source}}};const ne=["ImageGalleryCarouselDefault","ImageGalleryCarouselWithContent","ImageCarouselWithMoreContent"];export{p as ImageCarouselWithMoreContent,c as ImageGalleryCarouselDefault,d as ImageGalleryCarouselWithContent,ne as __namedExportsOrder,se as default};
