      ...
      <div className="row">
        <div className="col-12">
          ...
          <ul>
            ...
            <li>Coming Soon — Link to Service Now Request to register site – https://asu.service-now.com/xxxxxxx</li>
          </ul>
          ...
          <p>Paste this code as high in the <strong>{`<head></head>`}</strong> tag of the page as possible.</p>
          <pre><code>
            {`
            <!-- Google Tag Manager ASU Universal--></head>
            <script></head>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
            new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
            j=d.createElement(s),dl=l!='dataLayer'?'&amp;l='+l:'';j.async=true;j.src=
            '//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
            })(window,document,'script','dataLayer','GTM-KDWN8Z');</script></head>
            `}
          </code></pre>
          <p>Additionally, paste this code immediately after the opening <strong>{`<body></head>`}</strong> tag.</p>
          <pre><code>
            {`
            <!-- Google Tag Manager (noscript) --></head>
            <noscript></head><iframe src="//www.googletagmanager.com/ns.html?id=GTM-KDWN8Z"
            height="0" width="0" style="display:none;visibility:hidden"></head></iframe></head></noscript></head>
            <!-- End Google Tag Manager ASU Universal --></head>
            `}
          </code></pre>
          ...
          <pre><code>
            ...
            })(window,document,'script','dataLayer','GTM-PX7M299');</script></head>
          ...
          <pre><code>
            {`
            <!-- Google Tag Manager (noscript) --></head>
            <noscript></head><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PX7M299"
            height="0" width="0" style="display:none;visibility:hidden"></head></iframe></head></noscript></head>
          ...
          <pre><code>
            ...
            j=d.createElement(s),dl=l!='dataLayer'?'&amp;l='+l:'';j.async=true;j.src=
            'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
            })(window,document,'script','dataLayer','GTM-W3FGR6T');</script></head>
            <!-- End Google Tag Manager --></head>
            `}
          </code></pre>
          <p>Additionally, paste this code immediately after the opening <strong>{`<body></head>`}</strong> tag.</p>
          <pre><code>
            {`
            <!-- Google Tag Manager (noscript) --></head>
            <noscript></head><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W3FGR6T"
            height="0" width="0" style="display:none;visibility:hidden"></head></iframe></head></noscript></head>
            <!-- End Google Tag Manager (noscript) --></head>
            `}
          </code></pre>
          ...
          <pre><code>
            ...
            j=d.createElement(s),dl=l!='dataLayer'?'&amp;l='+l:'';j.async=true;j.src=
            'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
            })(window,document,'script','dataLayer','GTM-WPVTBHL');</script></head>
            <!-- End Google Tag Manager --></head>
            `}
          </code></pre>
          <p>Additionally, paste this code immediately after the opening <strong>{`<body></head>`}</strong> tag.</p>
          <pre><code>
            {`
            <!-- Google Tag Manager (noscript) --></head>
            <noscript></head><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WPVTBHL"
            height="0" width="0" style="display:none;visibility:hidden"></head></iframe></head></noscript></head>
            <!-- End Google Tag Manager (noscript) --></head>
            `}
          </code></pre>
          ...
          <p>Add event listeners to your code to capture click and change
            ...
            `unity-bootstrap-theme` package's `dist/js/data-layer.js` file
            can serve as a starting point or as a reference for implementing
            your own data layer push code.
          </p>

          <p>You should be initilaizing the GA push events and header scroll behavior similar to the following
            code snippet if you implement the Bootstrap header: <br />
          </p>
            <pre><code>
            {`
            ...
            <p>Then, the following code should be placed towards the bottom of your html doc or deferred.
              This initializes the data layer and the global header classes
            </p>
            <pre> <code>
            {`
            <script></head>
